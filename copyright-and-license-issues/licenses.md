...
One short answer is that for a few files in the p4c repository, and
some other p4lang repositories, releasing them under an Apache 2.0
license puts P4.org on [questionable legal
